...
const string strMessageMagic = "Nightcoin Signed Message:\n";
...
static int64_t nTargetTimespan = 275;  // 5 blocks
            ...
            if(IsProofOfStake() && pindex != NULL){
                if(pindex->GetBlockHash() == hashPrevBlock){
                    ...
                    if (false) {
                        ...
                        CNightcoinCoinAddress devRewardAddress(getDevAddress(pindex->nHeight + 1));
...
{
    RenameThread("nightcoin-loadblk");
