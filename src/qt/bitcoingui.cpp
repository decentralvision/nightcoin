...
{
    resize(900, 520);
    setWindowTitle(tr("Nightcoin") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
#endif
    setObjectName("GUI");
    setStyleSheet("#GUI {background-color: qradialgradient(cx: 0, cy: 1, fx: 0, fy: 0, radius: 1, stop: 0 #ffffff, stop: 1 #e0e0e0);}");
    // Accept D&D of URIs
    setAcceptDrops(true);
    ...
    statusBar()->setStyleSheet("#statusBar {color: #4c4c4c;}");
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Nightcoin address"));
    ...
    aboutAction = new QAction(tr("&About Nightcoin"), this);
    aboutAction->setToolTip(tr("Show information about Nightcoin"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Nightcoin"));
...
void BitcoinGUI::createToolBars()
{
    ...
    toolbar->setStyleSheet("QToolButton {color: #4c4c4c; font-size: 14px; font-weight: 400; padding: 3px; border: none;}"
    ...
    netLabel->setStyleSheet("#netLabel {color: #4c4c4c;}");
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Nightcoin client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Nightcoin client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Nightcoin network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Nightcoin address or malformed URI parameters."));
    }
